...
public class PersonManager {
	...
	private final String DB_URL      = "jdbc:oracle:thin:@coco.informatik.tu-cottbus.de:1521:dbis"; // URL des Datenbanksystems
	private final String DB_USERNAME = "STUD_DB_WS_2020_29"; // Nutzername
	private final String DB_PASSWORD = "7FAM8hDi"; // Passwort
	...
	private boolean initDBConnection()
	{
		...
		catch( ClassNotFoundException e ) // Oracle-Treiber nicht gefunden
		{
			...
			// je nach Betriebssystem unterscheidet sich die korrekte Angabe des Classpath etwas
			...
			System.out.println( "Oracle-Treiber wurde nicht gefunden! Wurde Startoption '" + startOption + "' korrekt gesetzt? " );
			return false;
		}
